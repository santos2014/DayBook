...
namespace DayBook.db
{
    public abstract class MySqlHelper
    {
        //数据库连接字符串
        private static string ConnectionString = "server=localhost;Database=daybook;Uid=daybook_user;Pwd=123";
        ...
        public static DataTable GetDataTable(string sql)
        {
            ...
            {
                PromptionMgr.Instance.Prompt(e.ToString(), Promption.Level.eError);
                dt = null;
            }
            finally
            {
